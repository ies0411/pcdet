...
class trackingEvaluation(object):
    ...
    def __init__(
        ...
        filename_test_mapping = "./data/tracking/evaluate_tracking.seqmap.val"
        self.n_frames = []
        self.sequence_name = []
    ...
    def saveToStats(self):
        ...
        with open(filename, "w+") as f:
            f.write("MOTA, MOTP, MOTAL, MODA, MODP, recall, precision, F1, FAR")
            f.write("MT, PT, ML, tp, fp, fn, id_switches, fragments")
            f.write("n_gt, n_gt_trajectories, n_tr, n_tr_trajectories")
        # dump = open(filename, "w+")
...
def evaluate(result_sha, mail):
    ...
    for c in ("car", "pedestrian"):
        ...
        try:
            ...
            mail.msg(
                "Feel free to contact us (lenz@kit.edu), if you receive this error message:"
            )
