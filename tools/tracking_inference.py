...
def parse_config():
    ...
    parser.add_argument(
        "--cfg_file",
        type=str,
        default="/mnt/nas2/users/eslim/tracking/dsvt_kitti_det_4/dsvt_voxel.yaml",
    ...
    parser.add_argument(
        "--ckpt",
        default="/mnt/nas2/users/eslim/tracking/dsvt_kitti_det_4/ckpt/checkpoint_epoch_14.pth",
        type=str,
