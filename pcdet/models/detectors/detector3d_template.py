...
#             backbone_3d_module.backbone_channels
...
#             if not self.model_cfg.DENSE_HEAD.CLASS_AGNOSTIC
#             else 1,
...
#             num_class=self.num_class
#             if not self.model_cfg.POINT_HEAD.CLASS_AGNOSTIC
#             else 1,
#             predict_boxes_when_training=self.model_cfg.get('ROI_HEAD', False),
#         )
...
#             voxel_size=model_info_dict['voxel_size'],
#             num_class=self.num_class
#             if not self.model_cfg.ROI_HEAD.CLASS_AGNOSTIC
#             else 1,
#         )
...
#         self, filename, logger, to_cpu=False, pre_trained_path=None
#     ):
